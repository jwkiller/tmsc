...
import com.fota.android.commonlib.recyclerview.WrapRecyclerAdapter;
 ...
 */
public class FotaRecyclerView extends RecyclerView {
    // 包裹了一层的头部底部Adapter
    ...
    public FotaRecyclerView(Context context) {
        super(context);
    }

    public FotaRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FotaRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
